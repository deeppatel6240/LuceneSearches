package org.example.lucene.searchtype.wildcardquery.finalwild;
...
public class WildCard {
    ...
    public static void main(String[] args) {
        ...
        indexSearchQuery.setSort(sortDetails);
        ...
        indexSearchQuery.setFilter(filterDetails);
        ...
        try {
            ...
            List<Document> searchResults = wildCard.performWildcardSearch(indexSearchQuery);
